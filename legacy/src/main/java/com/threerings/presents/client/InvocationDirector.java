...
//                 com.threerings.stats.Log.info("Cleared receiver " + StringUtil.shortClassName(decoder) +
//                          " " + rreg + ".");
            }
...
//         com.threerings.stats.Log.info("Registered receiver " + StringUtil.shortClassName(decoder) + " " + reg + ".");
    }
...
//         com.threerings.stats.Log.info("Sending invreq " + event + ".");
    ...
    protected void flushListeners (long now)
    {
        if (_listeners.size() > 0) {
            ...
            while (iter.hasNext()) {
                ...
                if (then > lm.mapStamp) {
//                     com.threerings.stats.Log.info("Flushing marshaller " + lm + ".");
                    iter.remove();
                }
            }
        }
